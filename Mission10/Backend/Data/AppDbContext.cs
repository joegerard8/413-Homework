...
// database context class. this is where all of the tables are defined and the relationships between them.
...
public partial class AppDbContext : DbContext
{
    ...
    // setting al the tables. only using 2 for this assignment but the rest are here
